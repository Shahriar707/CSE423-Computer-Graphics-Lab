...
def showScreen():
    ...
    draw_circle(310, 310, 150)

    # four circles with axis
    draw_circle(385, 310, 75)
    draw_circle(235, 310, 75)
    draw_circle(310, 385, 75)
    draw_circle(310, 235, 75)

    # four diagonal circles

    draw_circle((310 + (75/1.4142)), (310 + (75/1.4142)), 75)
    draw_circle((310 - (75/1.4142)), (310 + (75/1.4142)), 75)
    draw_circle((310 - (75/1.4142)), (310 - (75/1.4142)), 75)
    draw_circle((310 + (75/1.4142)), (310 - (75/1.4142)), 75)
